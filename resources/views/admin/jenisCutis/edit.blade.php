...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.jenisCuti.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.jenis-cutis.update", [$jenisCuti->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="kode_cuti">{{ trans('cruds.jenisCuti.fields.kode_cuti') }}</label>
                <input class="form-control {{ $errors->has('kode_cuti') ? 'is-invalid' : '' }}" type="text" name="kode_cuti" id="kode_cuti" value="{{ old('kode_cuti', $jenisCuti->kode_cuti) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jenis_cuti') ? 'is-invalid' : '' }}" type="text" name="jenis_cuti" id="jenis_cuti" value="{{ old('jenis_cuti', $jenisCuti->jenis_cuti) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('maks_pertahun') ? 'is-invalid' : '' }}" type="number" name="maks_pertahun" id="maks_pertahun" value="{{ old('maks_pertahun', $jenisCuti->maks_pertahun) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('keterangan') ? 'is-invalid' : '' }}" type="text" name="keterangan" id="keterangan" value="{{ old('keterangan', $jenisCuti->keterangan) }}">
