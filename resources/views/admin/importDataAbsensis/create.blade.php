...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.importDataAbsensi.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.import-data-absensis.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('jam_masuk') ? 'is-invalid' : '' }}" type="text" name="jam_masuk" id="jam_masuk" value="{{ old('jam_masuk') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('jam_keluar') ? 'is-invalid' : '' }}" type="text" name="jam_keluar" id="jam_keluar" value="{{ old('jam_keluar') }}">
