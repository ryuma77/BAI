    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-departmentNameSections">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.section.fields.department_name') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($sections as $key => $section)
                            <tr data-entry-id="{{ $section->id }}">
                                ...
                                <td>
                                    {{ $section->department_name->department_name ?? '' }}
                                </td>
                                <td>
                                    @can('section_show')
...
@endcan
  ...
  let table = $('.datatable-departmentNameSections:not(.ajaxTable)').DataTable({ buttons: dtButtons })
