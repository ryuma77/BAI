            ...
            <table class=" table table-bordered table-striped table-hover datatable datatable-Setting">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.setting.fields.auto_cancel_cuti') }}
                        </th>
                        <th>
                            {{ trans('cruds.setting.fields.awal_saldo_cuti') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
                ...
                <tbody>
                    @foreach($settings as $key => $setting)
                        <tr data-entry-id="{{ $setting->id }}">
                            ...
                            <td>
                                {{ App\Models\Setting::AUTO_CANCEL_CUTI_SELECT[$setting->auto_cancel_cuti] ?? '' }}
                            </td>
                            <td>
                                {{ App\Models\Setting::AWAL_SALDO_CUTI_SELECT[$setting->awal_saldo_cuti] ?? '' }}
                            </td>
                            <td>
                                @can('setting_show')
