...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.pengajuancuti.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.pengajuancutis.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('jenis_cuti') ? 'is-invalid' : '' }}" name="jenis_cuti_id" id="jenis_cuti_id" required>
                    @foreach($jenis_cutis as $id => $jenis_cuti)
                        <option value="{{ $id }}" {{ old('jenis_cuti_id') == $id ? 'selected' : '' }}>{{ $jenis_cuti }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_cuti') ? 'is-invalid' : '' }}" type="text" name="tanggal_cuti" id="tanggal_cuti" value="{{ old('tanggal_cuti') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lama_cuti') ? 'is-invalid' : '' }}" type="number" name="lama_cuti" id="lama_cuti" value="{{ old('lama_cuti', '1') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sisa_cuti') ? 'is-invalid' : '' }}" type="number" name="sisa_cuti" id="sisa_cuti" value="{{ old('sisa_cuti', '') }}" step="1">
