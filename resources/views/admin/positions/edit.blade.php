    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.positions.update", [$position->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('kode_jabatan') ? 'is-invalid' : '' }}" type="text" name="kode_jabatan" id="kode_jabatan" value="{{ old('kode_jabatan', $position->kode_jabatan) }}" required>
