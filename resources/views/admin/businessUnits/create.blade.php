    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.business-units.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_unit_code') ? 'is-invalid' : '' }}" type="text" name="business_unit_code" id="business_unit_code" value="{{ old('business_unit_code', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('business_unit_name') ? 'is-invalid' : '' }}" type="text" name="business_unit_name" id="business_unit_name" value="{{ old('business_unit_name', '') }}" required>
