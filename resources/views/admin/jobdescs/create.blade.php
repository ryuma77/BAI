...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.jobdesc.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.jobdescs.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jobdesc') ? 'is-invalid' : '' }}" type="text" name="jobdesc" id="jobdesc" value="{{ old('jobdesc', '') }}" required>
